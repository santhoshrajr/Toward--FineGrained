<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dataownerregistration.aspx.cs" Inherits="Dataownerregistration" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="427px" 
        ...
        <br />
            ...
            <center><asp:Label ID="Label1" runat="server" Text="Data Owner Registration" 
     ...
     <center>   <table class="style1">
            ...
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Dataowner.aspx" 
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" BorderColor="#0066FF" 
                        BorderStyle="Groove" onclick="Button1_Click" 
