<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dataowner.aspx.cs" Inherits="Dataowner" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="269px" 
        ...
        <center><asp:Label ID="Label1" runat="server" Text="Data Owner Login" 
     ...
     <center>   <table class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#FF33CC" 
                        NavigateUrl="~/Dataownerregistration.aspx" 
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td>
                    <asp:Label ID="Label4" runat="server" style="font-family: 'Blackadder ITC'"></asp:Label>
                </td>
            </tr>
        </table></center>
        <br />
